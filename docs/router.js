...
(function (root) {
  ...
  function shimTarget(loc) {
    loc = loc || {};
    var file = basename(loc.pathname || "");
    if (file !== "week.html" && file !== "job.html" && file !== "map.html" && file !== "teacher.html") {
      return null;
    }
  ...
  function isAppPath(pathname) {
    ...
    return file === "" || file === "index.html" || file === "week.html" || file === "job.html" || file === "map.html" || file === "teacher.html";
  }
