const CACHE = "bnei-study-v2";
const CORE = ["./", "index.html", "styles.css", "app.js", "map.html", "map.css", "map.js", "job.html", "weeks.json", "recap.json", "scripture_focus.json", "seal.png", "manifest.webmanifest"];
